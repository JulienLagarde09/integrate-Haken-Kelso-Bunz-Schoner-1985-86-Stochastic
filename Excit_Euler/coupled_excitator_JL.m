function ydot = single_excitator_JL(t,y,a,b,c,alpha,beta,gamma,dt1,dt2,dt3,...
...
%     
    ...
    ydot(1) = c*(y(2)+ gamma*y(1)-y(1)^3/3);% + (y(1)-y(3))*(alpha + beta*(y(1)-y(3)).^2);  
        
    ydot(2) =  -(y(1)-a + da + b*y(2))/c ;
    
    
    ydot(3) = c*(y(4)+ gamma*y(3)-y(3)^3/3);% + (y(3)-y(1))*(alpha + beta*(y(3)-y(1)).^2);  
        
    ydot(4) =  -(y(3)-a + da + b*y(4))/c ;
